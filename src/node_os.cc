...
static void GetUserInfo(const FunctionCallbackInfo<Value>& args) {
  ...
  .OnVal([&](Local<Value> options_envencoding_string) -> void {
Local<Value> encoding_opt = options_envencoding_string;
  ...
  Local<Object> entry = Object::New(env->isolate());
    ...
    return safeV8::Set(isolate, entry,env->uid_string(),uid)
  .OnVal([&]()-> safeV8::SafeV8Promise_Base {

    return safeV8::Set(isolate, entry,env->gid_string(),gid)
  .OnVal([&]()-> safeV8::SafeV8Promise_Base {

    return safeV8::Set(isolate, entry,env->username_string(),username)
  .OnVal([&]()-> safeV8::SafeV8Promise_Base {

    return safeV8::Set(isolate, entry,env->homedir_string(),homedir)
  .OnVal([&]()-> safeV8::SafeV8Promise_Base {

    return safeV8::Set(isolate, entry,env->shell_string(),shell)
  .OnVal([&]() -> void {

...
#define DEFINE_CTY_VAL(CType, JSType) \
  inline MVal<Local<Value>, CType> CType##Val(Isolate* isolate, Local<Value> v) { \
    if (v->Is##JSType()) { \
  ...
  \
  inline MVal<Local<Value>, CType> coerceTo##CType(Isolate* isolate, Local<Value> v) { \
...
inline MVal<Local<Value>, int64_t> int64_tVal(Isolate* isolate, Local<Value> v) {
  int64_t num;
...
inline MVal<Local<Value>, Local<String>> toString(Isolate* isolate, Local<Value> v) {
